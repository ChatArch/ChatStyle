...
Docs use `mkdocs-static-i18n` suffix mode:

- Chinese is the default site from `docs/*.md`.
- English pages come from `docs/*.en.md` and are built under `/en/`.
- The Material language selector is generated by the i18n plugin.
